...
abstract class DesignerContentListItem extends DesignerContentItem
{
    public $intro;
    ...
    protected function __construct($component, $componentParams, $article, $articleParams)
    {
        ...
        if (isset($this->_article->readmore) && $this->_articleParams->get('show_readmore') && $this->_article->readmore) {
            ...
            if ($this->_articleParams->get('access-view')){
                ...
                $returnURL = ContentHelperRoute::getArticleRoute($this->_article->slug, $this->_article->catid);
