...
?>
	<div class="input-append">
		<input class="hikashop_checkout_coupon_field" id="hikashop_checkout_coupon_input_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" type="text" name="checkout[coupon]" value="" placeholder="<?php echo JText::_('HIKASHOP_ENTER_COUPON'); ?>"/>
