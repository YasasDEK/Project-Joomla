...
<fieldset class="hkform-horizontal">
	<div class="hkform-group control-group hikashop_login_username_line">
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="text" id="username" name="login[username]" class="inputbox" alt="<?php echo JText::_('HIKA_USERNAME') ?>" size="18" placeholder="<?php echo JText::_('HIKA_USERNAME') ?>" />
		</div>
	</div>
	<div class="hkform-group control-group hikashop_login_password_line">
		<div class="<?php echo $inputcolumnclass;?>">
			<input type="password" id="passwd" name="login[passwd]" class="inputbox" size="18" alt="<?php echo JText::_('HIKA_PASSWORD') ?>" placeholder="<?php echo JText::_('HIKA_PASSWORD') ?>" />
		</div>
	</div>
<?php
