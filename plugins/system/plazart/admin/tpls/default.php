...
<form action="<?php echo JRoute::_('index.php?option=com_templates&layout=edit&id='.$input->getInt('id')); ?>" method="post" name="adminForm" id="style-form" class="form-validate form-horizontal">
    <div class="configure-content">
        <div class="config-view<?php echo $plazartlock=='global-config' || !in_array($plazartlock,array('global-config', 'menu-config', 'layout-config','typography-config','advanced-config','preset-config','child-override-config')) ? ' active': ''; ?>" id="plazart-global-config">
            <?php
